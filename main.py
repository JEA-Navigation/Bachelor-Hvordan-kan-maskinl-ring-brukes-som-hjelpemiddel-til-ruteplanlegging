...
# Beskrivelse:
# Denne koden henter miljøet fra newlabyrinth.py, trener på det og
# returnerer anbefalt handling og strategi 
# Dette er en visualiseringsfil for ruta, ikke en fil som brukes i programmet.
...
from convertbng.util import convert_epsg3857_to_wgs84
...
def q_learn(grid, epoch):
  ...
  for it in range(int(num_episodes)):
    ...
    while not grid.game_over():
      ...
      # Gjør oppdateringen av Q(s,a) i henhold til formel XXXX, side XXXX
  ...
  # Lagrer strategien til bruk i neste iterasjon
  global PREV_POLICY
  PREV_POLICY = policy
  ...
  if DEBUG:
    ...
    # Gir hver pixel i ruta gevinsten 5 for å vise den grafisk.
    ...
    # Initialiserer listene fyllt med 0er med like mange
    # verdier som det finnes koordinater i ruta
